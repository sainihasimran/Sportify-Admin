...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtem=(TextInputLayout)findViewById(R.id.email_login);
        txtpswd=(TextInputLayout)findViewById(R.id.pwd_login);
    ...
    public void adminsignin(View view)
    {
        ...
        String email=txtem.getEditText().getText().toString();
